...
public class Calculator implements ActionListener
{
	...
	public Calculator()
	{
		...
		p.setLayout(new GridLayout(5,4,30,50));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource().equals(eq))
		{
			...
			if(op==4)
				result=o.division(x,y);
			else if(op==3)
				result=o.multiplication(x,y);
			else if(op==2)
				result=o.difference(x,y);
			else 
				result=o.addition(x,y);
